...
/**
 * Created by wasim on 16/4/15.
 */
static class FixChar {
    ...
    static String removeSpecialCharacter(String text) {
        ...
        char[] text_char = extraChar.toArray()
    ...
    static void handleChar(int d) {
        ...
        switch (d) {
            ...
            case 171:
                if (XMLQuoteMode) {
                    setChar('&'); setChar('q'); setChar('u'); setChar('o');
                    setChar('t'); setChar(';');
    ...
    static void setChar(String ch) {
        extraChar << String.valueOf(ch as char)
    }
}
